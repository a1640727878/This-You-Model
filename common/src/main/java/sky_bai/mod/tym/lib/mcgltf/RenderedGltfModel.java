...
import sky_bai.mod.tym.api.ModelType;
import sky_bai.mod.tym.lib.jgltf.model.*;
import sky_bai.mod.tym.lib.jgltf.model.image.PixelData;
import sky_bai.mod.tym.lib.jgltf.model.image.PixelDatas;
import sky_bai.mod.tym.lib.jgltf.model.impl.DefaultNodeModel;
import sky_bai.mod.tym.lib.mikktspace.MikkTSpaceContext;
import sky_bai.mod.tym.lib.mikktspace.MikktspaceTangentGenerator;
...
public class RenderedGltfModel {
    ...
    protected final Map<MaterialModel, Material> extrasToMaterial = new IdentityHashMap<MaterialModel, Material>();
            ...
            if (normalsAccessorModel != null) {
                ...
                if (tangentsAccessorModel != null) {
                    ...
                    if (materialModel != null) {
                        ModelType<Material> type = obtainMaterial(gltfRenderData, materialModel);
                        if (type.is()) {
                            Material renderedMaterial = type.get();
    ...
    protected void processMeshPrimitiveModelIncludedTangent(List<Runnable> gltfRenderData, NodeModel nodeModel, MeshModel meshModel, MeshPrimitiveModel meshPrimitiveModel, List<Runnable> renderCommand, Map<String, AccessorModel> attributes, AccessorModel positionsAccessorModel, AccessorModel normalsAccessorModel, AccessorModel tangentsAccessorModel) {
        ...
        GL20.glVertexAttribPointer(vaPosition, positionsAccessorModel.getElementType().getNumComponents(), positionsAccessorModel.getComponentType(), false, positionsAccessorModel.getByteStride(), positionsAccessorModel.getByteOffset());
        ...
        GL20.glVertexAttribPointer(vaNormal, normalsAccessorModel.getElementType().getNumComponents(), normalsAccessorModel.getComponentType(), false, normalsAccessorModel.getByteStride(), normalsAccessorModel.getByteOffset());
        ...
        GL20.glVertexAttribPointer(at_tangent, tangentsAccessorModel.getElementType().getNumComponents(), tangentsAccessorModel.getComponentType(), false, tangentsAccessorModel.getByteStride(), tangentsAccessorModel.getByteOffset());
        ...
        if (colorsAccessorModel != null) {
            ...
            GL20.glVertexAttribPointer(vaColor, colorsAccessorModel.getElementType().getNumComponents(), colorsAccessorModel.getComponentType(), false, colorsAccessorModel.getByteStride(), colorsAccessorModel.getByteOffset());
        ...
        if (texcoordsAccessorModel != null) {
            ...
            GL20.glVertexAttribPointer(vaUV0, texcoordsAccessorModel.getElementType().getNumComponents(), texcoordsAccessorModel.getComponentType(), false, texcoordsAccessorModel.getByteStride(), texcoordsAccessorModel.getByteOffset());
            ...
            GL20.glVertexAttribPointer(mc_midTexCoord, texcoordsAccessorModel.getElementType().getNumComponents(), texcoordsAccessorModel.getComponentType(), false, texcoordsAccessorModel.getByteStride(), texcoordsAccessorModel.getByteOffset());
    ...
    protected void processMeshPrimitiveModelIncludedTangent(List<Runnable> gltfRenderData, NodeModel nodeModel, MeshModel meshModel, MeshPrimitiveModel meshPrimitiveModel, List<Runnable> renderCommand, List<Runnable> skinningCommand, Map<String, AccessorModel> attributes, AccessorModel positionsAccessorModel, AccessorModel normalsAccessorModel, AccessorModel tangentsAccessorModel) {
        ...
        GL20.glVertexAttribPointer(skinning_joint, jointsAccessorModel.getElementType().getNumComponents(), jointsAccessorModel.getComponentType(), false, jointsAccessorModel.getByteStride(), jointsAccessorModel.getByteOffset());
        ...
        GL20.glVertexAttribPointer(skinning_weight, weightsAccessorModel.getElementType().getNumComponents(), weightsAccessorModel.getComponentType(), false, weightsAccessorModel.getByteStride(), weightsAccessorModel.getByteOffset());
        ...
        GL20.glVertexAttribPointer(skinning_position, positionsAccessorModel.getElementType().getNumComponents(), positionsAccessorModel.getComponentType(), false, positionsAccessorModel.getByteStride(), positionsAccessorModel.getByteOffset());
        ...
        GL20.glVertexAttribPointer(skinning_normal, normalsAccessorModel.getElementType().getNumComponents(), normalsAccessorModel.getComponentType(), false, normalsAccessorModel.getByteStride(), normalsAccessorModel.getByteOffset());
        ...
        GL20.glVertexAttribPointer(skinning_tangent, tangentsAccessorModel.getElementType().getNumComponents(), tangentsAccessorModel.getComponentType(), false, tangentsAccessorModel.getByteStride(), tangentsAccessorModel.getByteOffset());
        ...
        GL20.glVertexAttribPointer(vaPosition, positionsAccessorModel.getElementType().getNumComponents(), positionsAccessorModel.getComponentType(), false, 0, 0);
        GL20.glEnableVertexAttribArray(vaPosition);

        GL15.glBindBuffer(GL15.GL_ARRAY_BUFFER, normalBuffer);
        GL20.glVertexAttribPointer(vaNormal, normalsAccessorModel.getElementType().getNumComponents(), normalsAccessorModel.getComponentType(), false, 0, 0);
        GL20.glEnableVertexAttribArray(vaNormal);

        GL15.glBindBuffer(GL15.GL_ARRAY_BUFFER, tangentBuffer);
        GL20.glVertexAttribPointer(at_tangent, tangentsAccessorModel.getElementType().getNumComponents(), tangentsAccessorModel.getComponentType(), false, 0, 0);
        GL20.glEnableVertexAttribArray(at_tangent);
    ...
    protected void processMeshPrimitiveModelIncludedTangent(List<Runnable> gltfRenderData, NodeModel nodeModel, MeshModel meshModel, MeshPrimitiveModel meshPrimitiveModel, List<Runnable> renderCommand, float[][] jointMatrices, Map<String, AccessorModel> attributes, AccessorModel positionsAccessorModel, AccessorModel normalsAccessorModel, AccessorModel tangentsAccessorModel) {
        ...
        GL20.glVertexAttribPointer(vaPosition, outputPositionsAccessorModel.getElementType().getNumComponents(), outputPositionsAccessorModel.getComponentType(), false, outputPositionsAccessorModel.getByteStride(), outputPositionsAccessorModel.getByteOffset());
        GL20.glEnableVertexAttribArray(vaPosition);
        ...
        GL20.glVertexAttribPointer(vaNormal, outputNormalsAccessorModel.getElementType().getNumComponents(), outputNormalsAccessorModel.getComponentType(), false, outputNormalsAccessorModel.getByteStride(), outputNormalsAccessorModel.getByteOffset());
        GL20.glEnableVertexAttribArray(vaNormal);
        ...
        GL20.glVertexAttribPointer(at_tangent, outputTangentsAccessorModel.getElementType().getNumComponents(), outputTangentsAccessorModel.getComponentType(), false, outputTangentsAccessorModel.getByteStride(), outputTangentsAccessorModel.getByteOffset());
        GL20.glEnableVertexAttribArray(at_tangent);
    ...
    protected void applyTransformVanilla(NodeModel nodeModel) {
        ...
        Matrix4fAPI.setMatrix4f(pose, findGlobalTransform(nodeModel));
    ...
    public ModelType<Material> obtainMaterial(List<Runnable> gltfRenderData, MaterialModel model) {
        ...
        if (model instanceof MaterialModelV2) {
            ...
            if (v2.getBaseColorTexture() != null)
                material.baseColorTexture = getTextureIndex(material, v2.getBaseColorTexture());
            if (v2.getNormalTexture() != null)
                material.normalTexture = getTextureIndex(material, v2.getNormalTexture());
            if (v2.getMetallicRoughnessTexture() != null)
                material.normalTexture = getTextureIndex(material, v2.getMetallicRoughnessTexture());
            material.initMaterialCommand(gltfRenderData, this);
            extrasToMaterial.put(model, material);
            type.set(material);
        } else {
            Object extras = model.getExtras();
            if (extras != null) {
                Gson gson = new Gson();
    ...
    private Material.TextureInfo getTextureIndex(Material material, TextureModel model) {
        int i = gltfModel.getTextureModels().indexOf(model);
        return Material.TextureInfo.get(material, i);
    }
    ...
    public int obtainGlTexture(List<Runnable> gltfRenderData, TextureModel textureModel) {
        ...
        if (glTexture == null) {
            ...
            int minFilter = Optionals.of(textureModel.getMinFilter(), GL11.GL_NEAREST_MIPMAP_LINEAR);
            int magFilter = Optionals.of(textureModel.getMagFilter(), GL11.GL_LINEAR);
            int wrapS = Optionals.of(textureModel.getWrapS(), GL11.GL_REPEAT);
            int wrapT = Optionals.of(textureModel.getWrapT(), GL11.GL_REPEAT);
    ...
    public static class Material {
        ...
        public class TextureInfo {
            ...
            public static TextureInfo get(Material material, int index) {
                TextureInfo info = material.new TextureInfo();
                info.index = index;
                return info;
            }
        }
